      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4">
        ...
        <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4 sm:p-5 shadow-xs hover:shadow-card transition-all">
          <div className="flex items-center justify-between gap-2 mb-2">
            ...
            <div className="flex items-center gap-1 rounded-full bg-emerald-100 dark:bg-emerald-950/60 px-2.5 py-0.5 text-xs font-bold text-emerald-950 dark:text-emerald-300 border border-emerald-300 dark:border-emerald-800 whitespace-nowrap shrink-0 shadow-xs">
        ...
        <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4 sm:p-5 shadow-xs hover:shadow-card transition-all">
          <div className="flex items-center justify-between gap-2 mb-2">
            ...
            <div className="flex items-center gap-1 rounded-full bg-amber-100 dark:bg-amber-950/60 px-2.5 py-0.5 text-xs font-bold text-amber-950 dark:text-amber-300 border border-amber-300 dark:border-amber-800 whitespace-nowrap shrink-0 shadow-xs">
          ...
          <div className="mt-2.5 flex items-center justify-between text-xs text-[var(--color-text-secondary)] font-mono font-bold">
        ...
        <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4 sm:p-5 shadow-xs hover:shadow-card transition-all">
          <div className="flex items-center justify-between gap-2 mb-2">
            ...
            <div className="flex items-center gap-1 rounded-full bg-blue-100 dark:bg-blue-950/60 px-2.5 py-0.5 text-xs font-bold text-blue-950 dark:text-blue-300 border border-blue-300 dark:border-blue-800 whitespace-nowrap shrink-0 shadow-xs">
        ...
        <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4 sm:p-5 shadow-xs hover:shadow-card transition-all">
          <div className="flex items-center justify-between gap-2 mb-2">
            ...
            <div className="flex items-center gap-1 rounded-full bg-purple-100 dark:bg-purple-950/60 px-2.5 py-0.5 text-xs font-bold text-purple-950 dark:text-purple-300 border border-purple-300 dark:border-purple-800 whitespace-nowrap shrink-0 shadow-xs">
          ...
          <div className="mt-3 space-y-1.5 text-xs font-mono text-[var(--color-text-secondary)] font-semibold">
        ...
        <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4 sm:p-5 shadow-xs hover:shadow-card transition-all">
          ...
          <div className="mt-3 space-y-2">
            <div className="flex items-center justify-between text-xs">
              <span className="text-[var(--color-text-primary)] font-mono font-bold">OpenAI gpt-4o-mini</span>
              <span className="font-mono font-extrabold text-amber-700 dark:text-amber-400">390ms</span>
            </div>
            <div className="h-2 w-full rounded-full bg-slate-200 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 overflow-hidden">
              <div className="h-full w-[39%] bg-amber-600 rounded-full" />
            </div>
            <div className="flex items-center justify-between text-xs pt-0.5">
              <span className="text-[var(--color-text-primary)] font-mono font-bold">Gemini 2.0 Flash (Failover)</span>
              <span className="font-mono font-extrabold text-blue-700 dark:text-blue-400">450ms</span>
            </div>
            <div className="h-2 w-full rounded-full bg-slate-200 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 overflow-hidden">
        ...
        <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4 sm:p-5 shadow-xs hover:shadow-card transition-all">
          <div className="flex items-center justify-between gap-2 mb-2">
            ...
            <div className="flex items-center gap-1 rounded-full bg-indigo-100 dark:bg-indigo-950/60 px-2.5 py-0.5 text-xs font-bold text-indigo-950 dark:text-indigo-300 border border-indigo-300 dark:border-indigo-800 whitespace-nowrap shrink-0 shadow-xs">
